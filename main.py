...
def train(args):
    ...
    bird_dataset = BirdDataset("train/Image","train/Mask",transform=x_transforms,target_transform=y_transforms)
    dataloaders = DataLoader(bird_dataset, batch_size=batch_size, shuffle=True, num_workers=4)
